...
module UART_IO_SYS_mm_interconnect_0 (
	...
	wire  [95:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> nios2_qsys_jtag_debug_module_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // nios2_qsys_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> nios2_qsys_jtag_debug_module_agent:cp_channel
	...
	wire   [5:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire  [19:0] pio_btn_s1_agent_m0_address;                                                      // pio_btn_s1_agent:m0_address -> pio_btn_s1_translator:uav_address
	...
	wire  [96:0] pio_btn_s1_agent_rf_source_data;                                                  // pio_btn_s1_agent:rf_source_data -> pio_btn_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_btn_s1_agent_rsp_fifo_out_data;                                               // pio_btn_s1_agent_rsp_fifo:out_data -> pio_btn_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                            // cmd_mux_003:src_valid -> pio_btn_s1_agent:cp_valid
	wire  [95:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> pio_btn_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // pio_btn_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> pio_btn_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                    // cmd_mux_003:src_startofpacket -> pio_btn_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                      // cmd_mux_003:src_endofpacket -> pio_btn_s1_agent:cp_endofpacket
	...
	wire  [95:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> pio_led_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                            // pio_led_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> pio_led_s1_agent:cp_channel
	...
	wire         nios2_qsys_jtag_debug_module_agent_rp_valid;                                      // nios2_qsys_jtag_debug_module_agent:rp_valid -> router_003:sink_valid
	wire  [95:0] nios2_qsys_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_jtag_debug_module_agent:rp_data -> router_003:sink_data
	wire         nios2_qsys_jtag_debug_module_agent_rp_ready;                                      // router_003:sink_ready -> nios2_qsys_jtag_debug_module_agent:rp_ready
	wire         nios2_qsys_jtag_debug_module_agent_rp_startofpacket;                              // nios2_qsys_jtag_debug_module_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         nios2_qsys_jtag_debug_module_agent_rp_endofpacket;                                // nios2_qsys_jtag_debug_module_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         pio_btn_s1_agent_rp_valid;                                                        // pio_btn_s1_agent:rp_valid -> router_005:sink_valid
	wire  [95:0] pio_btn_s1_agent_rp_data;                                                         // pio_btn_s1_agent:rp_data -> router_005:sink_data
	wire         pio_btn_s1_agent_rp_ready;                                                        // router_005:sink_ready -> pio_btn_s1_agent:rp_ready
	wire         pio_btn_s1_agent_rp_startofpacket;                                                // pio_btn_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         pio_btn_s1_agent_rp_endofpacket;                                                  // pio_btn_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [95:0] pio_led_s1_agent_rp_data;                                                         // pio_led_s1_agent:rp_data -> router_007:sink_data
	...
	wire         pio_btn_s1_agent_rdata_fifo_src_valid;                                            // pio_btn_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pio_btn_s1_agent_rdata_fifo_src_data;                                             // pio_btn_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pio_btn_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_003:in_0_ready -> pio_btn_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                // avalon_st_adapter_003:out_0_valid -> pio_btn_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                 // avalon_st_adapter_003:out_0_data -> pio_btn_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                // pio_btn_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                // avalon_st_adapter_003:out_0_error -> pio_btn_s1_agent:rdata_fifo_sink_error
	...
	UART_IO_SYS_mm_interconnect_0_router_001 router_001 (
	...
	UART_IO_SYS_mm_interconnect_0_router_003 router_003 (
	...
	UART_IO_SYS_mm_interconnect_0_router_003 router_004 (
	...
	UART_IO_SYS_mm_interconnect_0_router_002 router_005 (
	...
	UART_IO_SYS_mm_interconnect_0_router_002 router_006 (
	...
	UART_IO_SYS_mm_interconnect_0_router_002 router_007 (
	...
	UART_IO_SYS_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pll_0_outclk0_clk),                                           //        clk.clk
		.reset              (nios2_qsys_reset_n_reset_bridge_in_reset_reset),              //  clk_reset.reset
	...
	UART_IO_SYS_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
